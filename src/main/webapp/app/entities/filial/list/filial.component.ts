...
export class FilialComponent implements OnInit {
  ...
  trackId(index: number, item: IFilial): number {
    return item.id!;
  }
  ...
  protected onSuccess(data: IFilial[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
