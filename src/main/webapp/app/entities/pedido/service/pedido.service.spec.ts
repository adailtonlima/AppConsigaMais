...
describe('Service Tests', () => {
  describe('Pedido Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = {
        id: 0,
        estado: StatusPedido.PENDENTE,
        criado: currentDate,
        dataAprovacao: currentDate,
        dataExpiracao: currentDate,
        renda: 0,
        valorSolicitado: 0,
        qtParcelasSolicitado: 0,
        valorAprovado: 0,
        valorParcelaAprovado: 0,
        qtParcelasAprovado: 0,
        dataPrimeiroVencimento: currentDate,
        dataUltimoVencimento: currentDate,
      };
    });
    ...
    describe('Service methods', () => {
        ...
        const returnedFromService = Object.assign(
          {
            ...
            dataAprovacao: currentDate.format(DATE_TIME_FORMAT),
            dataExpiracao: currentDate.format(DATE_FORMAT),
            dataPrimeiroVencimento: currentDate.format(DATE_FORMAT),
            dataUltimoVencimento: currentDate.format(DATE_FORMAT),
          },
          elemDefault
        );
        ...
        const returnedFromService = Object.assign(
          {
            ...
            renda: 1,
            valorSolicitado: 1,
            qtParcelasSolicitado: 1,
            valorAprovado: 1,
            valorParcelaAprovado: 1,
            qtParcelasAprovado: 1,
            dataPrimeiroVencimento: currentDate.format(DATE_FORMAT),
            dataUltimoVencimento: currentDate.format(DATE_FORMAT),
          },
          elemDefault
      ...
      describe('addPedidoToCollectionIfMissing', () => {
        ...
        it('should add only unique Pedido to an array', () => {
          const pedidoArray: IPedido[] = [{ id: 123 }, { id: 456 }, { id: 76288 }];
