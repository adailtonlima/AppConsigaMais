...
import br.com.consiga.service.FuncionarioQueryService;
...
/**
 * REST controller for managing {@link br.com.consiga.domain.Funcionario}.
 */
@RestController
@RequestMapping("/api")
public class FuncionarioResource {
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/funcionarios/{id}", consumes = "application/merge-patch+json")
    ...
    public ResponseEntity<List<FuncionarioDTO>> getAllFuncionarios(FuncionarioCriteria criteria, Pageable pageable) {
